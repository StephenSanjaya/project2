<%@ Page Title="" Language="C#" MasterPageFile="~/View/MainPage.Master" AutoEventWireup="true" CodeBehind="InsertProductTypePage.aspx.cs" Inherits="Assignment.View.Admin.InsertProductTypePage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Table runat="server">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell>
                <asp:Button runat="server" ID="Insert" OnClick="Insert_Click" Text="Insert"/>
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
</asp:Content>
